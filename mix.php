...
// Insert tracking received into the database
    ...
    $sql = "SELECT MAX(tour) AS max_counter FROM fileattent";
    ...
    if ($result) {
        ...
        $newValueString = 'R' . strval($newValue);
        $insertSql = "INSERT INTO fileattent (tour, statu) VALUES ('$newValueString','0')";
        $sql2 = "SELECT MAX(tour) AS max_counterunserved FROM fileattent WHERE statu = '1'";
